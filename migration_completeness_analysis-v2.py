...
class MigrationCompletenessAnalyzer:
    ...
    def load_data(self, gcpj_file, primary_file, secondary_file, juridico_file):
        ...
        # Carregar planilhas com índices
    ...
    def analyze_gcpj_completeness(self):
        ...
        for gcpj in self.gcpj_list:
            ...
            # Verificar presença usando índices
            ...
            # Verificar completude por coluna
            filled_columns = 0
            ...
            if total_columns > 0:
                ...
                analysis['completeness_score'] = min(max(analysis['completeness_score'], 0), 100)
            else:
                analysis['completeness_score'] = 0.0
            logger.debug(f"GCPJ {gcpj}: filled_columns={filled_columns}, total_columns={total_columns}, score={analysis['completeness_score']:.2f}%")
