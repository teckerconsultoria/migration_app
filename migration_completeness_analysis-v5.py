...
class MigrationCompletenessAnalyzer:
    ...
    def __init__(self, weights=None):
        ...
        self.weights = weights or {'primary': 0.4, 'secondary': 0.2, 'juridico': 0.4}  # Ajustado para incluir secundária
        ...
        self.column_mapping = {
            ...
            # Dados de processo (base jurídica)
            'PROCESSO': ('juridico', 'PROCESSO'),
            'PROCEDIMENTO': ('juridico', 'TIPO_ACAO'),
            'NOME PARTE CONTRÁRIA PRINCIPAL': ('juridico', 'ENVOLVIDO'),
            'CPF/CNPJ': ('juridico', 'CPF'),
            ...
            'VARA': ('juridico', 'ORGAO_JULGADOR'),
            'COMARCA': ('juridico', 'COMARCA'),
            'UF': ('juridico', 'UF'),
            'RESPONSÁVEL PROCESSO [ESCRITÓRIO]': ('juridico', 'ADVOGADO_CONTRATADO'),
            # Constantes
        ...
        self.required_columns = {
            ...
            'secondary': ['GCPJ', 'TIPO'],
            'juridico': ['GCPJ', 'PROCESSO', 'TIPO_ACAO', 'ENVOLVIDO', 'CPF', 'AVALISTA 1', 'CPF/CNPJ Avalista 1']
        }
